*   [English](/docs/4.x/admin-manual/trouble-shooting/memory-management/overview/)
*   [中文](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/overview/)
*   [日本語](/ja/docs/4.x/admin-manual/trouble-shooting/memory-management/overview/)
...
## Doris BE 内存结构[​](#doris-be-内存结构 "Doris BE 内存结构的直接链接")

![Memory Structure](https://cdnd.selectdb.com/zh-CN/assets/images/memory-structure-c33470cfd0abfcf0b7ced0de7e483537.png)
...
![image](https://cdnd.selectdb.com/zh-CN/assets/images/memory-used-by-subsystem-e0a57a3b8ad8da7cea38ba33f5624c6f.png)
...
有关 Memory Tracker 的更多介绍参考 [内存跟踪器](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-feature/memory-tracker/)。

### 历史内存统计[​](#历史内存统计 "历史内存统计的直接链接")
...
![Bvar Memory](https://cdnd.selectdb.com/zh-CN/assets/images/bvar-memory-9c598521dff20751a24f3a3ae458096a.png)

当报错进程内存超限或可用内存不足时，在 `be/log/be.INFO` 日志中可以找到 `Memory Tracker Summary`，包含所有 `Type=overview` 和 `Type=global` 的 Memory Tracker，帮助使用者分析当时的内存状态，具体参考 [内存日志分析](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-analysis/memory-log-analysis/)
...
1.  [Jemalloc 内存分析](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-analysis/jemalloc-memory-analysis/)
    
2.  [全局内存分析](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-analysis/global-memory-analysis/)
    
3.  [Query 内存分析](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-analysis/query-memory-analysis/)
    
4.  [Load 内存分析](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-analysis/load-memory-analysis/)
    

* * *

## 内存问题 FAQ[​](#内存问题-faq "内存问题 FAQ的直接链接")

参考 [内存问题 FAQ](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-issue-faq/) 分析常见的内存问题。

* * *

## 内存控制策略[​](#内存控制策略 "内存控制策略的直接链接")

参考 [内存控制策略](/zh-CN/docs/4.x/admin-manual/trouble-shooting/memory-management/memory-feature/memory-control-strategy/) 中对内存分配、监控、回收的介绍，它们保证了 Doris BE 进程内存的高效可控。