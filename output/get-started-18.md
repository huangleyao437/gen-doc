*   [English](/docs/4.x/ai/ai-overview/)
*   [中文](/zh-CN/docs/4.x/ai/ai-overview/)
*   [日本語](/ja/docs/4.x/ai/ai-overview/)
...
## Agent Facing Analytics[​](#agent-facing-analytics "Agent Facing Analytics的直接链接")
...
## Hybrid Search and Analytics Processing[​](#hybrid-search-and-analytics-processing "Hybrid Search and Analytics Processing的直接链接")

![Hybrid Search and Analytics Processing 架构示意图](https://cdnd.selectdb.com/zh-CN/assets/images/image-5-a14bcf1ca9ea483a7d8e492f24f0e7a7.png)
...
## Lakehouse for AI[​](#lakehouse-for-ai "Lakehouse for AI的直接链接")
...
## RAG（Retrieval-Augmented Generation）[​](#ragretrieval-augmented-generation "RAG（Retrieval-Augmented Generation）的直接链接")
...
## AI Observability[​](#ai-observability "AI Observability的直接链接")
...
## Semantic Search[​](#semantic-search "Semantic Search的直接链接")
...
*   [文本搜索概述](/zh-CN/docs/4.x/table-design/index/inverted-index/overview/)
*   [向量搜索概述](/zh-CN/docs/4.x/table-design/index/vector-index/overview/)
*   [AI 函数概述](/zh-CN/docs/4.x/ai/ai-function-overview/)
